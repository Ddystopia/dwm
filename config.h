...
static const char *fonts[]          = { "Meslo LG S DZ:size=12","Ddystopian:size=22","monospace:size=12" };
...
/* tagging */
static const char *tags[] = { "1", "2", "3", "4", "5", "6", "7", "8", "9", "A", "B" };
...
static const char *dmenucmd[] = { "my_dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", col_gray1, "-nf", col_gray3, "-sb", col_cyan, "-sf", col_gray4, NULL };
...
static Key keys[] = {
	...
	{ MODKEY,                       XK_h,      shiftview_to_not_empty,      {.i = -1 } },
	{ MODKEY,                       XK_l,      shiftview_to_not_empty,      {.i = +1 } },
